...
def distance(sensorID, GPIO_TRIGGER, GPIO_ECHO, data):
    try:
        ...
        print("HC-SR04 %s is working properly" % (sensorID))
        data.append(distance)
    except:
        print("HC-SR04 %s has either malfunctioned or is disconnected" % (sensorID))
...
def read_temp():
    try:
        ...
        if equals_pos != -1:
            ...
            print("Temperature module DS18B20 is working properly")
            return temp_c
    except:
        print("Temperature module DS18B20 has either malfunctioned or is disconnected")
    ...
    try:
        ...
        while checker:
            ...
            try:
                ...
                y = float(axes['y'])
                z = float(axes['z'])
                print (("Digital accelerometer ADXL345 is working on address 0x%s:") % (add))
                data.append(x)
                data.append(y)
                data.append(z)
            except:
                print("Digital accelerometer ADXL345 has either malfunctioned or is disconnected")


            # vibration_state_read = open("vibration_sensor_data.txt", 'r')
            ...
            #     print("Vibration sensor SW-420 is working properly")
            # else:
            print("Vibration sensor SW-420 is working properly")
